...
export default function HeroSection() {
  ...
  return (
    <section className="border-b border-border-hairline pt-16 md:pt-20 pb-24 md:pb-32">
      {/* Same container as interior pages — max-w-7xl, same px */}
      <div
        ref={containerRef}
      ...
      >
        ...
        <h1
          data-hero
          className="text-headline-lg-mobile md:text-headline-xl text-primary max-w-3xl mb-8"
        >
          I build full-stack web applications that are simple to use, easy to
          maintain, and{" "}
          <span className="text-secondary">enjoyable to build.</span>
        </h1>
        <Link
          data-hero=""
          href="#work"
